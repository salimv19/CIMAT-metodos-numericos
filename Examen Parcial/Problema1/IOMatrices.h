...
public:
	...
	static void crea_archivo_matriz_completa(string nombreArchivo, vector<vector<double>>& matriz, int& N, int& M);
	static void crea_archivo_vector(string nombreArchivo, vector<double>& vector, int& N);
};