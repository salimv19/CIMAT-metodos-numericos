...
void IOMatrices::crea_archivo_matriz_completa(string nombreArchivo, vector<vector<double>>& matriz, int& N, int& M)
{
	ofstream salida;
...
void IOMatrices::crea_archivo_vector(string nombreArchivo, vector<double>& vector, int& N)
{
	ofstream salida;
